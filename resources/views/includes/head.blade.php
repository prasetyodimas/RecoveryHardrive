...
<link rel="stylesheet" type="text/css" href="{{asset('frontend/fronthemes/css/front-base.css')}}">
...
<script type="text/javascript" src="{{asset('frontend/plugins/Nicescroll/jquery.nicescroll.min.js')}}"></script>
<script type="text/javascript">
$(function(){
	$("body").niceScroll({
	    cursorcolor: "#ff4157", // change cursor color in hex
